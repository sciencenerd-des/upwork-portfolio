"""
SVG Icon System for the Automated Report Generator.

This module provides a consistent icon system using Lucide-style SVG icons.
All icons are inline SVG strings that can be embedded directly in HTML.
"""
...
def get_icon(name: str, size: int = ICON_MD, color: str = "currentColor", class_name: str = "") -> str:
    """
    Get an SVG icon by name.

    Args:
        name: Icon name (e.g., 'upload', 'settings', 'chart')
    ...
    """
    icon_svg = ICONS.get(name, ICONS.get('circle'))
    return f'''<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="{STROKE_WIDTH}" stroke-linecap="round" stroke-linejoin="round" class="{class_name}">{icon_svg}</svg>'''


# SVG path definitions (Lucide icon style)
ICONS = {
    # Navigation & Actions
    ...
    "file-pdf": '''<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M9 15v-2h2a1 1 0 0 1 0 2H9z"/><path d="M9 17v-2"/><path d="M14 15h1.5a.5.5 0 0 1 0 1H14v2"/>''',

    "file-word": '''<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M8 17l1.5-6 1.5 6 1.5-6 1.5 6"/>''',
...
# Template-specific icon mappings
TEMPLATE_ICONS = {
    "sales": "trending-up",
